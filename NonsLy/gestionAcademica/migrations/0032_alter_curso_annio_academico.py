# Generated by Django 4.1.3 on 2022-12-02 02:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gestionAcademica', '0031_alter_curso_annio_academico'),
    ]
